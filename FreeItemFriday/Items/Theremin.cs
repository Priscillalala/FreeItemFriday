    ...
    public class Theremin : ModModule<Theremin>
    {
        ...
        public override IEnumerator LoadContent()
        {
            ...
            SingleItemDisplayFrame.Create(Assets.Items.Theremin, displayPrefab)
                ...
                .Add(Idrs.Toolbot, "Pelvis", new Vector3(2.16572F, 1.92139F, 0.36732F), new Vector3(85.40151F, 186.2415F, 189.3237F), new Vector3(11.43646F, 11.43646F, 11.43646F))
                .Add(Idrs.Engi, "Pelvis", new Vector3(-0.12588F, 0.26729F, 0.16002F), new Vector3(85.04813F, 154.2319F, 180.0005F), new Vector3(1.1882F, 1.1882F, 1.1882F))
                .Add(Idrs.EngiTurret, "Base", new Vector3(0.7389F, 1.19324F, 0.1201F), new Vector3(289.3343F, 254.302F, 2.8411F), new Vector3(5.67193F, 5.67193F, 5.67193F))
                .Add(Idrs.EngiWalkerTurret, "Base", new Vector3(0.7389F, 1.19324F, 0.1201F), new Vector3(289.3343F, 254.302F, 2.8411F), new Vector3(5.67193F, 5.67193F, 5.67193F))
                .Add(Idrs.Mage, "Pelvis", new Vector3(0.21058F, 0.084F, -0.00462F), new Vector3(64.12035F, 235.4545F, 135.3318F), new Vector3(1.08244F, 1.08244F, 1.08244F))
                .Add(Idrs.Merc, "Stomach", new Vector3(0.1925F, -0.23371F, -0.13575F), new Vector3(299.6336F, 330.2855F, 344.6577F), new Vector3(1.33784F, 1.33784F, 1.33784F))
                .Add(Idrs.Treebot, "LowerArmL", new Vector3(-0.00397F, -0.03737F, 0.35329F), new Vector3(306.5481F, 357.0492F, 187.2086F), new Vector3(2.72495F, 2.72495F, 2.72495F))
                .Add(Idrs.Loader, "ThighR", new Vector3(-0.1191F, 0.55523F, -0.19393F), new Vector3(61.97856F, 349.4733F, 200.9573F), new Vector3(1.2811F, 1.2811F, 1.2811F))
                .Add(Idrs.Croco, "Head", new Vector3(-0.18713F, 5.86495F, -3.83413F), new Vector3(11.04338F, 1.05804F, 186.2499F), new Vector3(21.72311F, 21.72311F, 21.72311F))
